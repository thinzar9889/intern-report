...
class DashboardController extends Controller
{
        ...
        protected function adminDashboard()
        {
            ...
            $totalCompany = Company::count(); // Total companies in the system
            ...
            $totalUsers = User::count(); // Total interns in the system
            // $totalInternReports = WeeklyReport::count();
            // $totalEvaluations = Evaluation::count();

            //All intern male and female in system
            // $totalMale = Intern::where('interns.gender', 'Male')->count();
            // $totalFemale = Intern::where('interns.gender', 'Female')->count();
            return view('backend.dashboard.admin', compact('totalCompany','totalUsers','totalUniversity'));
        }
