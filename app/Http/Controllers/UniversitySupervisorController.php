...
class UniversitySupervisorController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->ajax()) {
            ...
            return DataTables::of($universitySupervisors)->addIndexColumn()
                ...
                // ->addColumn('interns', function ($data){
                //     $interns = '';
                //     foreach ($data->accessable_interns as $permission){
                //         $interns .= $permission->name . ', ';
                //     }
                //     // Remove the trailing comma and space if there are interns
                //     $interns = rtrim($interns, ', ');
                ...
                // ->filterColumn('accessable_interns', function($query, $keyword) {
    ...
    public function create()
    {
        ...
        $interns = Intern::all();
        return view('backend.university-supervisors.create', compact('universities','interns'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'address' => ['nullable'],
            'accessable_interns' => ['required']
        ],
            [
                'university_id.required' => 'The university field is required.',
                'accessable_interns.required' => 'The accessable interns field is required.'
    ...
    public function edit($id)
    {
        ...
        $universities = University::all();
        $interns = Intern::all();
        return view('backend.university-supervisors.edit', compact('universitySupervisor', 'universities','interns'));
    }
