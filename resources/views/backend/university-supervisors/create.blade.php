                                ...
                                <form action="{{ route('university-supervisors.store') }}" method="POST">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="university_id">University <span
                                                            class="text-danger">*</span></label>
                                                    <select
                                                        class="form-control select-university @error('university_id') is-invalid @enderror"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="accessable_interns">Accessable Interns</label>
                                                    <select name="accessable_interns[]" id="accessable_interns"
                                                        class="form-control select-intern @error('accessable_interns') is-invalid @enderror"
                                                        multiple>
                                                        <option value="">-- Choose Interns --</option>
                                                        @foreach ($interns as $intern)
                                                            <option value="{{ $intern->id }}">{{ $intern->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
