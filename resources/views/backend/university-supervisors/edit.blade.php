                        ...
                        <div class="card card-primary">
                            ...
                            <form action="{{ route('university-supervisors.update', $universitySupervisor->id) }}" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="accessable_interns">Accessable Interns <span class="text-danger">*</span></label>
                                        <select class="form-control @error('intern_id') is-invalid @enderror" name="accessable_interns[]" id="accessable_interns" multiple>
                                            <option value="">---</option>
                                            @foreach($interns as $intern)
                                                <option value="{{ $intern->id }}" {{ $universitySupervisor->accessable_interns == $intern->id ? 'selected' : '' }}>{{ $intern->name }}</option>
                                            @endforeach
                                        </select>
