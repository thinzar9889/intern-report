            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item {{ Request::segment(1) === 'dashboard' ? 'custom-active' : '' }}">
                    <a href="{{ route('dashboard') }}" class="nav-link"
                        @if (Request::segment(1) === 'dashboard') style="color: #0a0e14" @endif>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('internships.index') }}"
                                    class="nav-link {{ request()->route()->getName() === 'internships.index' ? 'active' : '' }}">
                            ...
                            @can('internship-create')
                                <li class="nav-item">
                                    <a href="{{ route('internships.create') }}"
                                        class="nav-link {{ request()->route()->getName() === 'internships.create' ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('weekly-reports.index') }}"
                                    class="nav-link {{ request()->route()->getName() === 'weekly-reports.index' ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Lists</p>
                                </a>
                            </li>
                            @can('weekly-report-create')
                                <li class="nav-item">
                                    <a href="{{ route('weekly-reports.create') }}"
                                        class="nav-link {{ request()->route()->getName() === 'weekly-reports.create' ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('intern-reports.index') }}"
                                    class="nav-link {{ request()->route()->getName() === 'intern-reports.index' ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Lists</p>
                                </a>
                            </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('evaluations.index') }}"
                                    class="nav-link {{ request()->route()->getName() === 'evaluations.index' ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Lists</p>
                                </a>
                            </li>
                            @can('evaluation-create')
                                <li class="nav-item">
                                    <a href="{{ route('evaluations.create') }}"
                                        class="nav-link {{ request()->route()->getName() === 'evaluations.create' ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('interns.index') }}"
                                    class="nav-link {{ request()->route()->getName() === 'interns.index' ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Lists</p>
                                </a>
                            </li>
                            @can('intern-create')
                                <li class="nav-item">
                                    <a href="{{ route('interns.create') }}"
                                        class="nav-link {{ request()->route()->getName() === 'interns.create' ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('companies.index') }}"
                                    class="nav-link {{ request()->route()->getName() === 'companies.index' ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Lists</p>
                                </a>
                            </li>
                            @can('company-create')
                                <li class="nav-item">
                                    <a href="{{ route('companies.create') }}"
                                        class="nav-link {{ request()->route()->getName() === 'companies.create' ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                ...
                @can('company-supervisor-list')
                    <li
                        class="nav-item {{ Request::segment(1) === 'company-supervisors' ? 'menu-is-opening menu-open' : '' }}">
                        <a href="#" class="nav-link">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('company-supervisors.index') }}"
                                    class="nav-link {{ request()->route()->getName() === 'company-supervisors.index' ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Lists</p>
                                </a>
                            </li>
                            @can('company-supervisor-create')
                                <li class="nav-item">
                                    <a href="{{ route('company-supervisors.create') }}"
                                        class="nav-link {{ request()->route()->getName() === 'company-supervisors.create' ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('universities.index') }}"
                                    class="nav-link {{ request()->route()->getName() === 'universities.index' ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Lists</p>
                                </a>
                            </li>
                            @can('company-create')
                                <li class="nav-item">
                                    <a href="{{ route('universities.create') }}"
                                        class="nav-link {{ request()->route()->getName() === 'universities.create' ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                ...
                @can('university-supervisor-list')
                    <li
                        class="nav-item {{ Request::segment(1) === 'university-supervisor-supervisors' ? 'menu-is-opening menu-open' : '' }}">
                        <a href="#" class="nav-link">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('university-supervisors.index') }}"
                                    class="nav-link {{ request()->route()->getName() === 'university-supervisors.index' ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Lists</p>
                                </a>
                            </li>
                            @can('university-supervisor-create')
                                <li class="nav-item">
                                    <a href="{{ route('university-supervisors.create') }}"
                                        class="nav-link {{ request()->route()->getName() === 'university-supervisors.create' ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('application.index') }}"
                                class="nav-link {{ request()->route()->getName() === 'application.index' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Lists</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('application.create') }}"
                                class="nav-link {{ request()->route()->getName() === 'application.create' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Create</p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('blogs.index') }}"
                                class="nav-link {{ request()->route()->getName() === 'blogs.index' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Lists</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('blogs.create') }}"
                                class="nav-link {{ request()->route()->getName() === 'blogs.create' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Create</p>
                            </a>
                        </li>
