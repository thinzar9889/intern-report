                    ...
                    <div class="row">
                        <div class="col-md-12 mt-3">
                            ...
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="{{ route('company-supervisors.update', $companySupervisor->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name"
                                                        ...
                                                        value="{{ old('name', $companySupervisor->name) }}">
                                                    @error('name')
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="email"
                                                        ...
                                                        value="{{ old('email', $companySupervisor->email) }}">
                                                    @error('email')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="phone"
                                                        ...
                                                        value="{{ old('phone', $companySupervisor->phone) }}">
                                                    @error('phone')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="position"
                                                        ...
                                                        value="{{ old('position', $companySupervisor->position) }}">
                                                    @error('position')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="company_id">Company <span
                                                            class="text-danger">*</span></label>
                                                    <select
                                                        class="form-control select-company @error('company_id') is-invalid @enderror"
                                                        name="company_id" id="company_id">
                                                        <option value="">---</option>
                                                        @foreach ($companies as $company)
                                                            <option value="{{ $company->id }}"
                                                                {{ $companySupervisor->company_id == $company->id ? 'selected' : '' }}>
                                                                {{ $company->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('company_id')
